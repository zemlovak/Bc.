...
\begin{minipage}[b]{0.9\linewidth}
  \centering
  \includegraphics[width=\linewidth]{sgf_fig.png}\vspace{0.25cm
  \subcaption{SGF}
  \label{fig:sgf_fig}}
\end{minipage}
\begin{minipage}[b]{0.9\linewidth}
  \centering
  \includegraphics[width=\linewidth]{median_fig.png}\vspace{0.25cm
  \subcaption{median}
  \label{fig:median_fig}}
\end{minipage}
\begin{minipage}[b]{0.9\linewidth}
  \centering
  \includegraphics[width=\linewidth]{ema_fig.png}\vspace{0.25cm
  \subcaption{EMA}
  \label{fig:ema_fig}}
\end{minipage}\vspace{0.4cm}
\caption{filtry}

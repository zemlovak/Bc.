...
Závislost váhy hodnoty (1 -- $\alpha$) na její vzdálenosti (\textit{k}) od současné hodnoty (\textit{$x_{t}$}) je graficky znázorněna na obr. č. \ref{fig:EMAexp} pro hodnotu $\alpha$ = 0.80. Z povahy křivky je patrné, že se opravdu jedná o exponenciálu, navíc s klesající tendencí, z čehož vyplývá, že skutečně čím vzdálenější je hodnota od hodnoty aktuální, tím menší má význam pro výpočet odezvy filtru.

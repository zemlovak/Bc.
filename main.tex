...
\label{sec:filtr1}
dopředná + zpětná filtrace \underline{\textcolor{red}{? LTI ?}} systémem\\
\ldots \\
\noindent Prvním z číslicových filtrů využitých v rámci programu je filtr s nulovým fázovým posunem. K implementaci tohoto druhu filtrace jsou nejčastěji využívány filtry IIR typu, které jsou výpočetně méně náročné, zároveň \ldots
